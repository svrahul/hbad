...
String param_names[] = {"Tidal Volu", "Resp Rate", "Peak Press", "FiO2", "IER", "PEEP", "PS1", "PS2"};
String param_units[] = {"ml", "bpm", "cmH2o", "%", "#", "cmH2o", "cmH2o", "cmH2o"};
int param_range_min[] = {150, 6, 37, 5, 20, 0, -1, -1};
int param_range_max[] = {800, 35, 60, 20, 100, 3, -1, -1};
int param_incr[] = {50, 1, 1, 1, 20, -1,-1, -1};
